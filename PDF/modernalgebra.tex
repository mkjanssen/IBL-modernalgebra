...
\addtocontents{toc}{\protect\hypertarget{g:book:idm270003639184}{}}
...
\thispagestyle{empty}
\hypertarget{g:colophon:idm269944732912}{}\vspace*{\stretch{2}}
...
\end{assemblage}
\footnotetext[2]{Sample statements could include ``\(m\) is really interesting'' or ``\(3m^2 + m + 2\) is even''.\label{g:fn:idm269943750528}}%
...
\end{theorem}
\footnotetext[1]{This approach to the Fundamental Theorem of Arithmetic is adapted from~[1.3.1].\label{g:fn:idm269943507392}}%
...
%
\end{investigation}
\footnotetext[1]{Sometimes called a \href{https://en.wikipedia.org/wiki/Rng_(algebra)}{\emph{rng}}. \(\ddot\smile\)\label{g:fn:idm269942564080}}%
...
\par\smallskip%
\noindent\textbf{Answer}.\hypertarget{g:answer:idm269942265088}{}\quad{}We have ``\(z\in \ideal{x} \Leftrightarrow x|z\)'' and ``\(\ideal{x}\subseteq \ideal{y} \Leftrightarrow y|x\)''\footnotemark{}.%
\par
...
\end{investigation}
\footnotetext[1]{An acceptable alternative would be: \(x\in \ideal{y}\). Make sure students are aware of this!\label{g:fn:idm269942263488}}%
Principal ideals may have more than one generator.%
\begin{theorem}{}{}{g:theorem:idm269942255552}%
Let \(R\) be a ring and \(a\in R\). Then \(\ideal{a} = \ideal{ua}\), where \(u\) is any unit of \(R\).%
\end{theorem}
\begin{proofptx}{}{g:proof:idm269942252160}
...
\par\smallskip%
\noindent\textbf{Solution}.\hypertarget{g:solution:idm269942243232}{}\quad{}%
\begin{enumerate}
