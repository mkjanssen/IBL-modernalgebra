...
\section*{A Note to Instructors}\addcontentsline{toc}{section}{A Note to Instructors}\label{Sec-NoteToInstructors}
...
\begin{theorem}\label{thm:ZisPID}
	...
	\begin{hint}Use properties specific to $\Z$, perhaps from Section \ref{Sec-Integers}.\end{hint}
\end{theorem}
...
\subsection{Quotient Rings}\label{SubSec-Quotient-Rings}
